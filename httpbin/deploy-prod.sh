...
gcloud docker -- push gcr.io/${PROJECT_PROD}/${HTTPBIN_IMAGE}
#gcloud docker -- push gcr.io/${PROJECT_PROD}/${NODE_IMAGE}

yes | gcloud beta container images add-tag gcr.io/${PROJECT_PROD}/${HTTPBIN_IMAGE}:$TRAVIS_COMMIT gcr.io/${PROJECT_PROD}/${HTTPBIN_IMAGE}:latest
